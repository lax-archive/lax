...
before pulling the large runtime image. Kernel replay and inspection use two
Lean workers inside their 16 GiB container limit so large module sets cannot
exhaust the hosted runner while the surrounding workflow remains responsive.
