...
// mathlib pin at the fake (see fake-mathlib.ts). LAX_E2E runs keep the real
// pin — combine LAX_E2E=1 only with the e2e test files, or every fast test
// will download real mathlib.
